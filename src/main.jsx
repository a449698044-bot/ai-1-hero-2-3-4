...
const tvcColumns = [
  {
    ...
    title: '回力1927TVC宣传视频',
    items: ['形象广告片', '品牌故事片'],
    video: './assets/huili-1927-tvc.m4v',
    coverTime: 2.8,
  },
  {
    number: '02',
    ...
    video: './assets/product-launch-tvc.mp4',
    coverTime: 3.2,
  },
  {
    number: '03',
    title: '白酒Tvc视频',
    items: ['白酒视频拍摄', '产品动态展示'],
    video: './assets/baijiu-tvc-collection.m4v',
    coverTime: 4.5,
  },
];
...
const ecommerceVideoCards = [
  {
    title: '食品类视频',
    label: 'FOOD VIDEO',
    videoPreview: './assets/food-video-01.mp4',
    videoAsCover: true,
    videos: [
      './assets/food-video-01.mp4',
      './assets/food-video-02.mp4',
      './assets/food-video-04.mp4',
      './assets/food-video-05.mp4',
      './assets/food-video-07.mp4',
      './assets/food-video-08.mp4',
      './assets/food-video-09.mp4',
      './assets/food-video-10.mp4',
    ],
  ...
  },
  {
    ...
    videoPreview: './assets/beverage-video-01.mp4',
    videoAsCover: true,
    videos: [
      './assets/beverage-video-01.mp4',
      './assets/beverage-video-02.mp4',
      './assets/beverage-video-03.mp4',
      './assets/beverage-video-04.mp4',
      './assets/beverage-video-05.mp4',
      './assets/beverage-video-06.mp4',
      './assets/beverage-video-07.mp4',
    ],
  ...
  },
  {
    ...
    videoPreview: './assets/apparel-main-video-01.mp4',
    videoAsCover: true,
    videos: [
      './assets/apparel-main-video-01.mp4',
      './assets/apparel-main-video-02.mp4',
      './assets/apparel-main-video-03.mp4',
      './assets/apparel-main-video-04.mp4',
      './assets/apparel-main-video-05.mp4',
      './assets/apparel-main-video-06.mp4',
      './assets/apparel-main-video-07.mp4',
      './assets/apparel-main-video-08.mp4',
      './assets/apparel-main-video-09.mp4',
      './assets/apparel-main-video-10.mp4',
      './assets/apparel-main-video-11.mp4',
      './assets/apparel-main-video-12.mp4',
    ],
  ...
  },
  {
    ...
    videoPreview: './assets/women-shoe-main-video-01.m4v',
    videoAsCover: true,
    videos: [
      './assets/women-shoe-main-video-01.m4v',
      './assets/women-shoe-main-video-02.m4v',
      './assets/women-shoe-main-video-03.mp4',
      './assets/women-shoe-main-video-04.mp4',
      './assets/women-shoe-main-video-05.m4v',
      './assets/women-shoe-main-video-06.mp4',
      './assets/women-shoe-main-video-07.mp4',
      './assets/women-shoe-main-video-08.mp4',
      './assets/women-shoe-main-video-09.mp4',
      './assets/women-shoe-main-video-10.mp4',
      './assets/women-shoe-main-video-11.mp4',
      './assets/women-shoe-main-video-12.mp4',
    ],
  ...
  },
  {
    ...
    videoPreview: './assets/jewelry-main-video-01.mp4',
    videos: [
      './assets/jewelry-main-video-01.mp4',
      './assets/jewelry-main-video-02.mp4',
      './assets/jewelry-main-video-03.mp4',
      './assets/jewelry-main-video-04.mp4',
      './assets/jewelry-main-video-05.mp4',
      './assets/jewelry-main-video-06.mp4',
      './assets/jewelry-main-video-07.mp4',
    ],
  ...
  },
  {
    ...
    videoPreview: './assets/lifestyle-main-video-01.mp4',
    videoAsCover: true,
    videos: [
      './assets/lifestyle-main-video-01.mp4',
      './assets/lifestyle-main-video-02.mp4',
      './assets/lifestyle-main-video-03.mp4',
      './assets/lifestyle-main-video-04.mp4',
      './assets/lifestyle-main-video-05.mp4',
      './assets/lifestyle-main-video-06.mp4',
      './assets/lifestyle-main-video-07.mp4',
      './assets/lifestyle-main-video-08.mp4',
      './assets/lifestyle-main-video-09.mp4',
      './assets/lifestyle-main-video-10.mp4',
      './assets/lifestyle-main-video-11.mp4',
    ],
